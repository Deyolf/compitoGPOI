...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($action == "insert") {
        $stmt = $conn->prepare("INSERT INTO evento(luogo, data, posti_totali, posti_disponibili, posti_occupati) VALUES (?,?,?,?,?)");
        $stmt->bind_param("sssss", $location, $data,$posti,$posti_dis,$posti_occ);
